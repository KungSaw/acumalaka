getgenv().ATConfig = {
    ...
    PetsToTrade = {"Crystal Egg", "Admin Abuse Egg", "2D Doggy", "2D Kitty", "Dragonfruit Fox", "Velocirooster", "Chihuahua", "Strawberry Tortle", "Huntsman Robin", "Three Blind Mice", "Purrowl", "Little Lamb"},
