getgenv().VO_CONFIG = {
    ...
    CustomPenPets = {
        ...
        "Galapagos Sea Lion", "Abyssinian Cat", "Badger", "Black Rhino",
        "California Condor", "Black-Footed Ferret", "Corgi",
